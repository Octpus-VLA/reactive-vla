...
| `download-dataset --repo-id user/name` | Download a Hugging Face Hub dataset into `datasets/` (exactly where `viz`/`train`/`merge-rollouts` etc. expect a local dataset) |
